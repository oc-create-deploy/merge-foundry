...
public static class BuildScript
{
    public static void BuildIos()
    {
        ...
        const string appIconPath = "Assets/Brand/MergeFoundry-AppIcon.png";
        Directory.CreateDirectory(outputPath);

        PlayerSettings.companyName = "Playable Games";
        PlayerSettings.productName = "Merge Foundry";
        PlayerSettings.SetApplicationIdentifier(BuildTargetGroup.iOS, "Com.play.mergegame");
